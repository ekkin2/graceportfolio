## Rules
- **Code Conciseness**: Minimize line count while maintaining complete functionality. Write efficient, compact code. Willing to tradeoff readability in excahnge for code compactness and minimal line numbers 
- **No Comments**: Do not add comments when writing code. Code should be self-explanatory.
- **Simplicity First**: Prefer simple, straightforward solutions over complex ones. Avoid over-engineering.
